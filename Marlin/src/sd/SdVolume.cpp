...
#include "../MarlinCore.h"
  ...
  DiskIODriver_SPI_SD *SdVolume::sdCard_;       // pointer to SD card object  // @advi3++ Save memory
 ...
 */
bool SdVolume::init(DiskIODriver_SPI_SD * const dev, const uint8_t part) { // @advi3++ Save memory
