 ...
 */
#ifdef ADVi3PP_BLTOUCH
// @advi3++: BLTouch probe uses Z-Max endstop
 ...
 *    (0,0)
 */
// @advi3++: Set the position of the probe (front-left). Adjust these values if your probe is elsewhere
...
// @advi3++: Use two measures, one fast, one slow
...
// @advi3++: The bed dimensions of Wanhao i3 Plus is 200x200x180
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
