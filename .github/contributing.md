...
We have a Facebook page where our knowledgable user community can provide helpful advice if you have questions. I do provide support but only for supporters on the project on Patreon.

* [ADVi3++ Facebook Page](https://www.facebook.com/advi3pp/)
* [ADVi3++ Supporters on Patreon](https://www.patreon.com/andrivet)
...
* **Perform a [cursory search](https://github.com/andrivet/ADVi3pp-Marlin/issues?q=is%3Aissue)** to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Unsure where to begin contributing to ADVi3++? You can start by looking through these `good-first-issue` and `help-wanted` issues:
...
Pull Requests should always be targeted to the advi3++ branch and never to development branches (e.g., `advi3++dev`). If this is your first Pull Request, please read Github's [Pull Request](https://help.github.com/articles/creating-a-pull-request/) documentation.
